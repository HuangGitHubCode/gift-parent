  ...
  <div>
    ...
    <el-form :model="tenant" ref="tenantForm" :rules="formRules" label-position="left" label-width="100px" class="demo-ruleForm login-container">
      ...
      <el-form-item prop="logo" label="租户Logo">
        ...
        <el-upload
            class="upload-demo"
            action="https://yaosang-gift-20221121.oss-cn-chengdu.aliyuncs.com"
      ...
      <el-form-item prop="admin.confirmPassword" label="确认密码">
        <el-input type="password" v-model="tenant.admin.confirmPassword" auto-complete="off" placeholder="请输入确认密码！"></el-input>
      </el-form-item>
...
Vue.use(BaiduMap, {
  ...
  ak: 'uTDNUplXio1K8VrDtKaG6N6kNUnxdk8j'
});
export default {
  data() {
  ...
  methods: {
    ...
    async beforeUpload(){
      await this.$http.get("/common/aliyun/oss/sign").then(response=>{
        //设置相关的参数
