<template>
	<section>
      ...
      <el-table-column prop="email" label="简介" width="120" sortable>
      </el-table-column>
      <el-table-column prop="age" label="创建时间" width="180" sortable>
      </el-table-column>
...
<script>
	...
	export default {
      ...
      // 查询部门树
      getDeptTree(){
        this.$http.get("/employee/deptTree")
            .then(res=>{
      ...
      handleSizeChange(val){
        ...
        // 发送请求 请求后台
        this.$http.post("/employee",this.queryFrom).then(res=>{
          // console.log(res)
          res = res.data.data
          this.list = res.list
